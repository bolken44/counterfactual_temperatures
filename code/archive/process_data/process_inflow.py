...
for year in range(1990, 1992):
      directory = f"{migration}{year}to{year+1}CountyMigration/{year}to{year+1}CountyMigrationInflow"
...
for year in range(2004, 2011):
      ...
      if year == 2004: file = f"countyin{year_str}{year_str_1}us1.dat"
      elif year in range(2005,2007): file = f"countyin{year_str}{year_str_1}.dat"
      elif year == 2007: file = f"co{year_str}{year_str_1}us.dat"
      elif year >= 2008: file = f"countyinflow{year_str}{year_str_1}.dat"
...
for year in range(2011, 2022):
      ...
      file = f"{migration}countyinflow{year_str}{year_str_1}.csv"
...
final_df.to_stata(f"{outcomes}migrationin_1990_2022.dta", write_index=False)
print(f"Migration data saved to {outcomes}migrationin_1990_2022.dta")