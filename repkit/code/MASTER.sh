...
#     This code is meant to be run on a high-computing cluster (HPC).
...
# To download the ERA 5 Land temperature raw data, follow the directions on .
#     - you must create a .csdapirc file in your home directory of the server.
